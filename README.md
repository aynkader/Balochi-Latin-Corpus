...
* **[32,000 Sentences Dataset (CSV)](dataset.csv)**: A parallel corpus featuring bilingual sentence pairs mapped side-by-side for machine learning model alignment[cite: 3].
* 
